...
<head>
	...
	<link rel="stylesheet" href="{{asset('app-assets/css/responsive.css')}}" type="text/css" />
...
<body class="stretched">
			...
			<div id="header-wrap">
				...
				<div class="container clearfix">
					...
					<div id="logo">
						...
						<!-- <a href="{{ url('/') }}" class="retina-logo">{{ config('app.name', 'Laravel') }}</a> -->
		...
		<footer id="footer" class="dark">
			...
			<div id="copyrights">
				...
				<div class="container clearfix">
					...
					<div class="col_half">
						Copyrights &copy; 2019 All Rights Reserved by EKapal.<br>
	...
	============================================= -->
	<script type="text/javascript" src="{{asset('app-assets/js/jquery.js')}}"></script>
	<script type="text/javascript" src="{{asset('app-assets/js/plugins.js')}}"></script>
